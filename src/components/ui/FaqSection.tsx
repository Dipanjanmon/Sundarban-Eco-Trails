...
export default function FaqSection() {
    return (
        <section className="py-24 bg-slate-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-1/2 h-full bg-emerald-100/30 rounded-l-[100%] blur-3xl -z-10 transform translate-x-1/3"></div>

            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-16 items-start">

                    {/* Left Column: Heading */}
                    <div className="w-full lg:w-1/3 pt-4 sticky top-32">
                        ...
                        <h3 className="text-4xl md:text-5xl font-bold text-slate-900 font-display mb-6">
                        ...
                        <a
                            href="/faqs"
                            className="inline-flex items-center justify-center bg-slate-900 text-white font-semibold py-4 px-8 rounded-full hover:bg-emerald-600 hover:shadow-xl transition-all duration-300 w-full md:w-auto"
                        >
                            Read All FAQs
                        </a>
                    </div>
                    ...
                    <div className="w-full lg:w-2/3">
                        ...
                        <div className="mt-8 bg-emerald-900 rounded-3xl p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-xl">
                            <div>
                                <h4 className="text-white font-bold text-xl font-display mb-2">Still planning your trip?</h4>
                                <p className="text-emerald-200 text-sm">Chat directly with our naturalist team on WhatsApp.</p>
                            </div>
                            <a
